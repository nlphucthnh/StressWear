...
public class PaypalService {
	...
	public Payment createPayment(Double total, String currency, PaypalPaymentMethod method, PaypalPaymentIntent intent,
		...
		double usdAmount = total / 23748.0; // Giả sử tỷ giá 1 USD = 23,748 VND

		// Làm tròn và định dạng số thập phân
		DecimalFormat decimalFormat = new DecimalFormat("#,##0.00");
		usdAmount = Double.parseDouble(decimalFormat.format(usdAmount));
